package com.atguigu.ems.hibernate;
...
public class HibernateDao<T, PK extends Serializable> extends
	 ...
	 * @return
	 */
	public Criterion buildPropertyFilterCriterion(String propertyName,
	 ...
	 * @return
	 */
	public Criteria setPageParameter(Criteria criteria, Page<T> page) {
	 ...
	 * @return
	 */
	public Query setPageParameter(Query query, Page<T> page) {
	...
	public Page<T> findPage(final Page<T> page, final String propertyName, final Object propertyValue){
